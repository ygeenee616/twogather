    ...
    <Container>
      ...
      <div>
        ...
        <Content>
          ...
          <Input type="number" id="inputPhone" placeholder="01012345678"></Input>
        </Content>
        <Content>
          <label for="inputEmail">
            <span style={{color:'red'}}>*</span> 이메일 :
          </label>
          <Input type="text" id="inputEmail" placeholder="abc@naver.com"></Input>
        </Content>
        <Content>
          <label for="inputPurpose">사용 목적 :</label>
          <Input type="text" id="inputPurpose" placeholder="공간의 사용 목적을 입력해주세요"></Input>
        </Content>
        <Content>
          <label for="inputRequest">요청 사항 :</label>
          <Input type="text" id="inputRequest" placeholder="호스트에게 요청할 사항이 있다면 남겨주세요"></Input>
        </Content>
